      ...
      case 'generating':
        return (
          <div className="text-center animate-in fade-in zoom-in duration-500">
            ...
            <h2 className="text-4xl font-black mb-6 bg-gradient-to-r from-orange-400 via-pink-500 to-purple-500 bg-clip-text text-transparent tracking-tight">
              {isGenerating ? 'Creating Your Plan' : 'All Done!'}
            </h2>
